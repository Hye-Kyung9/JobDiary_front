...
//         const response = await axios.get(
//           "https://cors-anywhere.herokuapp.com/http://cors-anywhere.herokuapp.com/http://openapi.work.go.kr/opi/opi/opia/wantedApi.do?authKey=WNL1TYI6B8EEDV4BS5BZ92VR1HK&callTp=L&returnType=XML&startPage=1&display=10&occupation=024"
//         );
//         const xml = new XMLParser().parseFromString(response.data); // Assume xmlText contains the example XML
//         const parsingData = xml.getElementsByTagName("wanted");
//         console.log(parsingData);
